...
const primaryColor = Color(0xFF810B07);
const primaryColorLight = Color(0xb9810b07);
...
const introBg = Color(0xFFece5db);
const introBtnBg = Color(0xFFfbaf35);
const backGroundColor = Color(0xFFF3F3F3);
const toastTextColor = Colors.white;

const btnStartColor = Color(0xFF10955B);
const btnEndColor = Color(0xFF06646F);
